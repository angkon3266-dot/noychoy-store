    ...
    */
    ...
    'pages' => [
        ...
        'paths' => [
            ...
            // The React pages live under a capital-P `Pages`. Inertia's default
            // is lowercase, which a case-insensitive Windows disk forgives and
            // a Linux one does not — without this every assertInertia() fails
            // on the server with "page component file does not exist".

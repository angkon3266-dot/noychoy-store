...
return [
    ...
    'defaults' => [
        ...
        // Bangla by the owner's call (2026-09-10): it converts better with this
        // audience. The 7-day badge came off to keep the list short; the refund
        // policy page still carries the 7-day window.
        'trust_badges' => [
